...
const dummyAircrafts = [
  { aircraft_id: 1, model: 'Boeing 737', capacity: 180 },
  { aircraft_id: 2, model: 'Airbus A320', capacity: 160 },
  { aircraft_id: 3, model: 'Embraer E190', capacity: 100 },
];
...
export default function AircraftsPage() {
  ...
  const filteredAircrafts = dummyAircrafts.filter((aircraft) =>
