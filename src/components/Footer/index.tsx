        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-body-color dark:text-body-color-dark">
                  Conectando destinos y personas desde 2023. En Ali Airways nos comprometemos a brindarte la mejor
                  experiencia de vuelo con seguridad, puntualidad y excelente servicio.
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Enlaces Útiles</h2>
                <ul>
                  <li>
                    <Link
                      href="/blog"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Términos Legales</h2>
                <ul>
                  <li>
                    <Link
                      href="/"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                <h2 className="mb-10 text-xl font-bold text-black dark:text-white">Soporte y Ayuda</h2>
                <ul>
                  <li>
                    <Link
                      href="/contact"
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              © 2023 Ali Airways. Todos los derechos reservados.
            </p>
          </div>
        </div>
